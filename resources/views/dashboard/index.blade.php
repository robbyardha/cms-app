                    ...
                    <div class="card-body">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                @foreach ($postPublishLikeComment as $index => $postLikeComment)
                                    <tr>
                                        <td scope="row">{{ $index + 1 }}</td>
                                        <td>{{ $postLikeComment->title }}</td>
                                        <td>{{ $postLikeComment->likes_count }}</td>
                                        <td>{{ $postLikeComment->comments_count }}</td>
                                    </tr>
                                @endforeach
