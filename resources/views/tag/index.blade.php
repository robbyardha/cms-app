...
@section('content')
    ...
    @include('tag.modal_add')
    @include('tag.modal_edit')
    ...
    <script>
        $(document).ready(function() {
            $('#myTable').DataTable({
                ...
                processing: true,
                serverside: true,
                ajax: "{{ url('/master/tag/getDataAjax') }}",
                columns: [{
                        data: 'DT_RowIndex',
                        name: 'No',
                        orderable: true,
